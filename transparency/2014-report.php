    ...
    <div class="wrapper">
        ...
        <section id="first-tab-group" class="tabgroup">
          <div id="tab1" style="display: block;">
            <img src="../_assets/img/transparency/star-table2014-major.png">
          </div>
          <div id="tab2" style="display: none;">
            <img src="../_assets/img/transparency/star-table2014-minor.png">
          </div>
          <div id="tab3" style="display: none;">
            <img src="../_assets/img/transparency/star-table2014-transit.png">
          </div>
        </section>
...
<!--     <script type="text/javascript" async="" src="./transparency_files/ga.js"></script><script id="twitter-wjs" src="./transparency_files/widgets.js"></script><script type="text/javascript" async="" defer="" src="./transparency_files/piwik.js"></script><script src="./transparency_files/jquery.min.js"></script> -->


<!-- <style>@media print {#ghostery-purple-box {display:none !important}}</style><script type="text/javascript" charset="utf-8" async="" src="./transparency_files/button.3943c052be33b5e812dac6838df9cb3d.js"></script></head>
 -->
</head>
...
<section class="container"><!-- #container -->
  ...
  <section id="hero">
    <img src="./transparency_files/hero-banner-2014.png" alt="Keeping Internet Users in the Know or in the Dark: Data Privacy Transparncy of Canadian Internet Carriers">
...
<div class="wrapper">
    ...
    <ul class="tabs clearfix" data-tabgroup="first-tab-group">
      <li><a href="https://www.ixmaps.ca/transparency.php#tab1" class="active"><img src="./transparency_files/st-thumb1.png" alt="Major Retailers"></a></li>
      <li><a href="https://www.ixmaps.ca/transparency.php#tab2"><img src="./transparency_files/st-thumb2.png" alt="Minor Retailers"></a></li>
      <li><a href="https://www.ixmaps.ca/transparency.php#tab3"><img src="./transparency_files/st-thumb3.png" alt="Transit Retailers"></a></li>
    </ul>

    <section id="first-tab-group" class="tabgroup">
      <div id="tab1" style="display: block;">
        <img src="./transparency_files/star-table2014-major.png">
      </div>
      <div id="tab2" style="display: none;">
        <img src="./transparency_files/star-table2014-minor.png">
      </div>
      <div id="tab3" style="display: none;">
        <img src="./transparency_files/star-table2014-transit.png">
      </div>
    </section>
  ...
  <section id="download">
    <h3><a class="btn" href="https://www.ixmaps.ca/transparency/img/DataPrivacyTransparencyofCanadianCarriers-2014.pdf" target="_blank">Download the Full 2014 Report</a></h3>
    <p>Download the complete <em>“Keeping Internet Users in the Know or in the Dark”</em> report (PDF)
                        <br>Or, read the <a href="https://www.ixmaps.ca/transparency-2013.php" target="blank">2013 Report</a> in our archives.</p>
  </section>
  ...
  <section id="toc">
    <h2>Report Summary</h2>
    <ul>
      <li><a href="https://www.ixmaps.ca/transparency.php#evaluating">Evaluating Internet Carrier Transparency</a></li>
      <li><a href="https://www.ixmaps.ca/transparency.php#changes">Main Changes from the 2013 Report</a></li>
                                    <li><a href="https://www.ixmaps.ca/transparency.php#findings">Findings</a></li>
      <li><a href="https://www.ixmaps.ca/transparency.php#recommendations">Policy Recommendations</a></li>
        <ul>
          <li><a href="https://www.ixmaps.ca/transparency.php#forcarriers">For Carriers that Handle Canadian Internet Traffic</a></li>
          <li><a href="https://www.ixmaps.ca/transparency.php#forcrtc">For Privacy Commissioners and the CRTC</a></li>
          <li><a href="https://www.ixmaps.ca/transparency.php#forpoliticians">For Legislators and Politicians</a></li>
          <li><a href="https://www.ixmaps.ca/transparency.php#forlaw">For Canadian Law Enforcement and Security Agencies</a></li>
        </ul>
      <li><a href="https://www.ixmaps.ca/transparency.php#authors">About the Authors</a></li>
      <li><a href="https://www.ixmaps.ca/transparency.php#acknowledgements">Acknowledgements</a></li>
    </ul>
  </section><!-- end of #toc -->
...
<<<<<<< HEAD
    ...
    <section id="changes">
          <div class="ui divider"></div>
        <h3>Main Changes from the 2013 Report</h3>
    ...
    <section id="findings">
        ...
        <p>As the Star Tables make clear, <strong>internet carriers are generally not transparent in their handling of personal information,</strong> earning on average only 2 stars out of 10 possible.</p>

        <p><strong>No carrier earned a full star in any of these four criteria:</strong></p>
            <ul>
        ...
        <p><strong>The ‘fighting brands’ of major mobile carriers, Virgin Mobile, Fido and Koodo, all score below average and are significantly less transparent than their corporate owners, Bell, Rogers and Telus respectively.</strong></p>

        <p><strong>Only one company stands out by earning more than 5 stars. TekSavvy</strong>, achieved 6 stars in aggregate based on full or half stars across eight criteria, the widest spectrum of privacy transparency of any carrier.</p>

        <p><strong>For the first time in 2014, Canadian internet carriers have begun issuing Transparency Reports</strong> that systematically provide statistics and other relevant details on law enforcement requests for personal data.  Rogers, Sasktel, Telus, Teksavvy, and Wind are the pioneers. Carriers are also being more publically explicit about what they require from law enforcement when making such requests for personal subscriber information. </p>
    ...
    <section id="recommendations">
        ...
        <p>Carriers should to go beyond minimum compliance with Canadian privacy law, and, in the spirit of PIPEDA’s Principle 8 – Openness, commit proactively to making the information identified by the ten criteria readily available publicly. In particular, they should publish on the privacy/transparency articles of their corporate websites:</p>
...
=======
    ...
    <h6 id="notes">Notes</h6>
      <ol class="notes">
            <li id="fn1">
                                                    Alex Boutilier, <a href="http://www.thestar.com/news/canada/2014/04/29/telecoms_refuse_say_how_often_they_hand_over_customers_data.html" target="_blank">Government agencies seek telecom user data at ‘jaw-dropping’ rates,</a> Toronto Star, Apr 29 2014.
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn1-inline">↩</a></li>

                                                <li id="fn2">
                                                    Personal Information Protection and Electronic Documents Act
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn2-inline">↩</a></li>


                                                <li id="fn3">
                                                    Note for instance that the latest incarnation of highly controversial ‘lawful access’ legislation, Bill C-13 - Protecting Canadians from Online Crime Act, passed into law October 20, 2014.
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn3-inline">↩</a></li>
                                                ...
                                                <li id="fn4">
                                                    Current Federal Bills:
                                                        ...
                                                        <br> C-44 - Protection of Canada from Terrorists Act, 2014
                                                        <br> C-51 - Anti-terrorism Act, 2015
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn4-inline">↩</a></li>

                                                <li id="fn5">
                                                    In the case of criterion 9 – Publicly visible steps to avoid U.S. routing of Canadian data, we also examine the peering arrangements noted on the websites of the  main Canadian public internet exchanges, TorIX, OttIX and YYCIX (Toronto/Ottawa/Calgary Internet Exchanges) as these are also publicly visible.
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn5-inline">↩</a></li>

                                                <li id="fn6">
                                                    <a href="http://innovationlaw.org/3_plus_3" target="blank">The 3+3 Project: Evaluating Canada’s Wireless Carriers’ Data Privacy Transparency</a>, 2014-2015 Centre for Innovation Law and Policy Volunteer Student Working Group, Centre for Innovation Law and Policy (CILP), Faculty of Law, University of Toronto, March 12, 2015.
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn6-inline">↩</a></li>

                                                <li id="fn7">
                                                    Division into these three tables was based primarily on the difference in role, between Canadian retail ISP and backbone transit carrier, and then secondarily among retail carriers based on the prominence of their internet presence in Canada, rather than their telephone or other service offerings.
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn7-inline">↩</a></li>

                                                <li id="fn8">
                                                    <a href="https://ixmaps.ca/explore" target="blank">https//ixmaps.ca/explore</a>
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn8-inline">↩</a></li>
                                                ...
                                                <li id="fn9">
                                                    ...
                                                    <br>
                                                    Lisa M Austin and Daniel Carens-Nedelsky, Jurisdiction still matters: The Legal Contexts of Extra-National Outsourcing, presented at the Assessing Privacy Risks of Extra-National Outsourcing of eCommunications public forum, Seeing Through the Cloud: Why Jurisdiction Still Matters in a Digitally Interconnected World, University of Toronto, March 6, 2015. <a href="http://mediacast.ic.utoronto.ca/20150306-eComm/index.htm" target="blank">See webcast.</a>
                                                    <a class="returntoarticle" href="https://www.ixmaps.ca/transparency.php#fn9-inline">↩</a></li>
      </ol>
    ...
    <h3 id="acknowledgements">Acknowledgements</h3>
      ...
      <p class="cc">
      <a class="cc-image" rel="license" href="https://creativecommons.org/licenses/by/4.0/" target="_blank"><img alt="Creative Commons License" style="border-width:0" src="./transparency_files/88x31.png"></a>
      <br>
      <span xmlns:dct="http://purl.org/dc/terms/" href="http://purl.org/dc/dcmitype/Text" property="dct:title" rel="dct:type"><em>"Keeping internet users in the know or in the dark: A report on the data privacy transparency of Canadian internet carriers"</em></span> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://ixmaps.ca/transparency.php" property="cc:attributionName" rel="cc:attributionURL">Andrew Clement and Jonathan Obar </a> is licensed under a <a rel="license" href="https://creativecommons.org/licenses/by/2.5/ca/" target="_blank">Creative Commons Attribution 2.5 Canada (CC BY 2.5 CA) </a>.
      </p>
  </section>
...
<footer>
  ...
  <section id="footer-outer-block">
    <div class="database-status-container">
      <b>DATABASE STATUS:</b>
      <span>
          <b>Traceroutes:</b> 165133<br>
      </span>
      |
      <span>
          <b>Submitters:</b> 652<br>
      </span>
      |
      <span>
          <b>Originating Addresses:</b> 610<br>
      </span>
      |
      <span>
          <b>Destination URLs:</b> 3992<br>
      </span>
      |
      <span>
          <b>IP Addresses:</b> 52626<br>
      </span>
    </div>
    ...
    <aside class="footer-segment">
      ...
      Last modified Wednesday, 14th December, 2016 @ 05:14pm<br>
      <!-- <p>Please <a href="mailto: ixmaps@utoronto.ca?subject=IXmaps Website" class="smallinks">contact the site admin</a> with any questions or concerns.</p> -->
      </p><p>To view our privacy policy, please <a href="https://www.ixmaps.ca/privacy.php" target="_blank">click here</a>.</p>

      <div id="footer-button-container">
        <iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" title="Twitter Tweet Button" src="./transparency_files/tweet_button.3748f7cda49448f6c6f7854238570ba0.en.html" style="position: static; visibility: visible; width: 61px; height: 20px;"></iframe>
        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
        <a id="feedback-button" href="mailto: ixmaps@utoronto.ca?subject=[IXmaps%20Feedback]">Feedback</a>
      </div>
...
<iframe id="rufous-sandbox" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" style="position: absolute; visibility: hidden; display: none; width: 0px; height: 0px; padding: 0px; border: none;" title="Twitter analytics iframe" src="./transparency_files/saved_resource.html"></iframe></body><div class="hovercards-root"><div data-reactroot=""></div></div></html>
>>>>>>> origin/master
