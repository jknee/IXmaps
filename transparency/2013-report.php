...
<div class="content">
  ...
  <article id="contents">
    ...
    <section id="evaluating">
        <h3>Evaluating ISP Transparency</h3>
    ...
    <section id="recommendations">
      ...
      <h4 id="forpoliticians">Recommendation for Legislators and Politicians</h4>
        ...
        <blockquote cite="./See where your data packets go _ IXmaps_files/facts">
      ...
      <h4 id="forlaw">Recommendation for Canadian Law Enforcement and Security Agencies</h4>
        ...
        <p><strong>This report calls on ISPs, regulators, legislators, law enforcement and security agencies to remove the systemic barriers to data privacy transparency, and to implement a more proactive approach requiring robust public transparency norms.</strong></p>
